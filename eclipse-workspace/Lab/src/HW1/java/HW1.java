...
public class HW1 {
	...
	public static void main(String[] args) {
		...
		int num5=3;
		int sum=num4+num5
		System.out.println("變數num4的值是:"+num4);
		System.out.println("變數num5的值是:"+num5);
		System.out.println("num4+num5的值是:"+sum);
		num4=num4+1;
		System.out.println("變數num4的值加一之後是:"+num4);
		//p34
		int num6=10;
		int num7=5;
		...
		double div1=num8/num9;
		double div2=(double)num8/(double)num9;
